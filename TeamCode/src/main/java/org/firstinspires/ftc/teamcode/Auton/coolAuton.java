...
@Autonomous(group="intothedeep", name="cool auton")
public class coolAuton extends LinearOpMode {
    enum STATE {
        ENTRANCE,
        PICKUP1,
        PICKUP2,
...
//                .waitSeconds(0.25)
        ...
        TrajectorySequence park =  drive.trajectorySequenceBuilder(pickup2.end())
