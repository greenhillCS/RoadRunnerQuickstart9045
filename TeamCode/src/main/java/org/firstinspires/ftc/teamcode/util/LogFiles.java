...
public final class LogFiles {
    ...
    public static class LogFile {
        ...
        public double mecTransP = DriveConstants.TRANSLATIONAL_PID.kP;
        public double mecTransI = DriveConstants.TRANSLATIONAL_PID.kI;
        public double mecTransD = DriveConstants.TRANSLATIONAL_PID.kD;
        public double mecHeadingP = DriveConstants.HEADING_PID.kP;
        public double mecHeadingI = DriveConstants.HEADING_PID.kI;
        public double mecHeadingD = DriveConstants.HEADING_PID.kD;
        public double mecLateralMultiplier = DriveConstants.LATERAL_MULTIPLIER;
