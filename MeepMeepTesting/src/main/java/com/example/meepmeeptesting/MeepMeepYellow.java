...
public class MeepMeepYellow {
    public static void main(String[] args) {
        ...
        RoadRunnerBotEntity myBot = new DefaultBotBuilder(meepMeep)
                ...
                .setConstraints(60, 60, Math.toRadians(60), 4.467498059104943, trackWidth)
